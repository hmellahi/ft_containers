...
void testModifiers()
{
...

    {
        ...
        for (size_t i = 0; i < 1e6; i++)
        {
            ...
            // ft_m3.insert(ft::make_pair(i, "string1")); todo
        }
    ...
    {
        {
            ...
            {
                m2.insert(std::make_pair(i, "string2"));
                // ft_m2.insert(ft::make_pair(i, "string2")); todo
            }
        ...
        // const std::map<std::string, std::string, std::greater<std::string> >::iterator iter = std::next(m1.begin()); todo
        // const ft::pair<std::string, std::string> &ft_ref = *(ft_m1.begin()); todo
        // const ft::map<std::string, std::string, std::greater<std::string> >::iterator ft_iter = std::next(ft_m1.begin()); todo
...
void testObservers()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (size_t i = 0; i < 1e2; i++)
        {
            ...
            // ft_m.insert(ft::make_pair(i, -1)); todo
        }
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        // ft::pair<char, int> highest = *mymap.rbegin(); // last element todo
        ...
        //     sum += it->second;
        //     s_key += it->first;
        // } while (mymap.value_comp()(*it++, highest)); todo
...
void testOperations()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        /*---------------------------------- time limit test --------------------------------------------*/
        {
            ...
            {
                m.insert(std::make_pair(i, "value"));
                // ft_m.insert(ft::make_pair(i, "value")); todo
            }
            start = get_time();
            res = m.count(1e6 - 10);
            end = get_time();
        ...
        for (size_t i = 0; i < 9; ++i)
        {
            ...
            // ft_m.insert(ft::make_pair(arr[i], "value")); todo
        }
...
void testRetionalOperators()
{
    ...
    for (size_t i = 0; i < 1e6; ++i)
    {
        ...
        // ft_m1.insert(ft::make_pair(i + 1, "value1")); todo
    }
