              ...
              << "] --------------------]\t\t\033[0m";
    {
        /*---------------------------------- time limit test --------------------------------------------*/
        {
            ...
            for (int i = 0; i < 1e6; i++)
            {
                ...
                my_m.insert(ft::make_pair(i, std::string("range constructor test")));
            }
...
void testModifiers()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
...

        {
            ...
            /*------------------ ft::maps ---------------------*/
            ualarm(diff * 1e3, 0);
            ft_m1.insert(ft::make_pair((int)1e9, std::string("string2")));
            ualarm(0, 0);
            /*----------------------------------------------------*/
        }
...
if (!cond)
        ...
        for (int i = 0; i < 1e5; i++)
        {
            ...
            ft_m2.insert(ft::make_pair(i, string("string1")));
        }
