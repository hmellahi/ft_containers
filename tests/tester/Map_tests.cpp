...
void iterator_tests(void)
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (int i = 0; i < 5; ++i)
        {
            ...
            my_m.insert(ft::make_pair(13, std::string("HELLO")));
        }
...
void testObservers()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::pair<const char, int> highest = *(mymap.rbegin()); // todo : char isnot working but char is
...
void testOperations()
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (int i = 0; i < 9; ++i)
        {
            ...
            ft_m.insert(ft::make_pair(arr[i], std::string("value")));// todo
        }
